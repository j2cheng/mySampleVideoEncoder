...
public class MainActivity extends AppCompatActivity
    ...
    private final boolean mIsFrontCamera = false;
    ...
    private void openCamera(int width, int height) {
        if (!hasPermissionGranted(RECORD_PERMISSIONS)) {
            Log.e(TAG, "Camera does not have permission to record video!!!!!!!!!!!!!!");//Crestron changes
...
//start of Crestron changes
            Log.i(TAG, "Camera permission: doing checkSelfPermission");
            //hasPermissionGranted take String array.
            if (ActivityCompat.checkSelfPermission(MainActivity.this, Manifest.permission.CAMERA) !=
                PackageManager.PERMISSION_GRANTED) {
                    Log.i(TAG, "Camera does not have permission: Manifest.permission.CAMERA");
            }
            else
            {
                Log.i(TAG, "Camera permission: Manifest.permission.CAMERA --> PERMISSION_GRANTED");
            }

            if (ActivityCompat.checkSelfPermission(MainActivity.this, android.Manifest.permission.CAMERA) !=
                PackageManager.PERMISSION_GRANTED) {
                    Log.i(TAG, "Camera does not have permission: android.Manifest.permission.CAMERA");
            }
            else
            {
                Log.i(TAG, "Camera permission: android.Manifest.permission.CAMERA --> PERMISSION_GRANTED");
            }

//            if (ActivityCompat.checkSelfPermission(MainActivity.this, Manifest.permission.SYSTEM_CAMERA) !=
//                PackageManager.PERMISSION_GRANTED) {
//                    Log.i(TAG, "Camera does not have permission: Manifest.permission.SYSTEM_CAMERA");
//            }
//            else
//            {
//                Log.i(TAG, "Camera permission: Manifest.permission.SYSTEM_CAMERA --> PERMISSION_GRANTED");
//            }

//            if (ActivityCompat.checkSelfPermission(MainActivity.this, android.Manifest.permission.SYSTEM_CAMERA) !=
//                PackageManager.PERMISSION_GRANTED) {
//                    Log.i(TAG, "Camera does not have permission: android.Manifest.permission.SYSTEM_CAMERA");
//            }
//            else
//            {
//                Log.i(TAG, "Camera permission: android.Manifest.permission.SYSTEM_CAMERA --> PERMISSION_GRANTED");
//            }

            Log.i(TAG, "Camera.getNumberOfCameras return: " + Camera.getNumberOfCameras());


            String cameraIds[] ;
            try {
                cameraIds = manager.getCameraIdList();
                Log.i(TAG, "CameraManager.getCameraIdList device length: " + cameraIds.length);

                if(cameraIds.length == 0)
                {
                    Log.i(TAG, "Camera return due to length is zero");
                    return;
                }
                ...
                Log.i(TAG, "Camera couldn't find camera device");
            }
//end of Crestron changes

            String cameraId = manager.getCameraIdList()[0];
            Log.d(TAG, "Camera manager.getCameraIdList()[0]: " + cameraId);//Crestron change

            if (mIsFrontCamera) {
                cameraId = manager.getCameraIdList()[1];
                Log.i(TAG, "Camera manager.getCameraIdList()[1]: " + cameraId);//Crestron change
            }
            ...
            Log.i(TAG, "chooseVideoSize: mVideoSize: " + mVideoSize);//Crestron change
            ...
            Log.i(TAG, "getOutputSizes: width: " + width + ", height: " + height);//Crestron change
